...
class AutonomyLoop:
    ...
    def run(
        ...
        *,
        ...
        while True:
            ...
            if not self._context.check_budget():
            ...
            decision = evaluate_termination(
                ...
                policy=self._termination_policy,
                state=term_state,
                budget_ok=self._context.check_budget(),
    ...
    def _apply_learning(self, evaluation: EvaluationResult, metrics: CycleMetrics) -> None:
        ...
        if (
            ...
            for proposal in proposals:
                self._procedure_updater.apply_update(proposal)
