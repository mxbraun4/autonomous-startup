...
def test_startup_vc_adapter_simulation_and_metrics():
    ...
    assert simulation["measurement_source"] == "http_checks"
...
def test_startup_vc_adapter_accepts_legacy_kwargs():
    """Adapter should accept and ignore legacy customer simulation kwargs."""
    adapter = StartupVCAdapter(
        use_customer_simulation=True,
        customer_seed_path="fake.json",
